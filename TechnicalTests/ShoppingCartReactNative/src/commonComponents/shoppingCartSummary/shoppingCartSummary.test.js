...
describe('Given the ShoppingCartSummary component', () => {
  describe('When it is rendered ', () => {
    describe('When the navogateToContinueShoppingButton button is pressed', () => {
      test('Then the navigation.navigate should be called', () => {
        ...
        fireEvent.press(getByTestId('navogateToContinueShoppingButton'));
