const petitionsRoutes = {
  ...
  OBSOLETES_RATED_PRODUCTS_CASA: 'http://192.168.1.129:4000/obsoletes/api/ratedProducts',
  ...
  OBSOLETES_NEW_PRODUCT_CASA: 'http://192.168.1.129:4000/obsoletes/api/ratedProducts',
  ...
  REQUEST_REGISTER_CASA: 'http://192.168.1.129:4000/obsoletes/api/user/register',
  ...
  REQUEST_LOGIN_CASA: 'http://192.168.1.129:4000/obsoletes/api/user/login',
  ...
  REQUEST_LOGOUT_CASA: 'http://192.168.1.129:4000/obsoletes/api/user/logout',
  ...
  SEND_FEEDBACK_CASA: 'http://192.168.1.129:4000/obsoletes/api/ratedSingleProduct',
  ...
  SEARCH_COMMERCIAL_PRODUCTS_CASA: 'http://192.168.1.129:5000/megaCo/api/product'
